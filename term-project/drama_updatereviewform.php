...
?>
	<div id="wrapper">
		<fieldset>
            <legend>미드 게시판 수정 하기</legend>
			<form method="post" enctype="multipart/form-data" action="drama_updatereview.php">
				리뷰 메모:<br/>
				<textarea name="memo" cols="50" rows="10"><?php echo $_GET['memo']; ?></textarea>
